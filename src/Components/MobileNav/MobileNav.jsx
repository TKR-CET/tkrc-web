...
const MobileNav = () => {    
  ...
  useEffect(() => { if (userData?.role === "faculty") fetchClassOptions(); }, [userData]);    
  ...
  return (    
    <div className="mobile-nav-container">    
      ...
      <div className={`menu ${menuOpen ? "menu-open" : ""}`}>    
        ...
        <Link to="/index"><MenuItem label="Home" /></Link>    
        <Link to={studentId ? "/Schedule" : "/timetable"}><MenuItem label="Timetable" /></Link>    
